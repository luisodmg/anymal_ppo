...
def pick_latest_checkpoint(save_dir=SAVE_DIR):
    candidates = glob.glob(os.path.join(save_dir, "*_policy.pt")) + \
                 glob.glob(os.path.join(save_dir, "*olicy*.pt"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--std-init", type=float, default=0.85820,
    ...
    make_video(num_videos=args.num_videos, std_init=args.std_init, policy_path=policy_path)
